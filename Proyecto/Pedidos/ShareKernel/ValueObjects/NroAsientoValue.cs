...
{
    // Valida el ingreso del Nro. de Asiento al generar el pase a bordo
    // Ejm. válidos: 1F, 11E, 7A, etc.
    public record NroAsientoValue : ValueObject
    {
        ...
        public NroAsientoValue(string nroAsiento)
        {
            ...
            if (fila < 1 || fila > 20)
            {
                throw new BusinessRuleValidationException("El número de la fila es incorrecto!");
            }
